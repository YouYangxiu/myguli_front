...
<td colspan="3" class="Title red f18 fb"><p>限时折扣</p></td>
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          <label for="Agree">
            <p class="on">
              <input type="checkbox" checked="checked"/>我已阅读并同意<a href="javascript:" target="_blank">《谷粒学院购买协议》</a></p>
          </label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          ...
          <div class="fr">
            <p>
              共 <strong class="red">1</strong> 件商品，合计<span class="red f20">￥<strong id="AllPrice">{{
                order.totalFee
              }}</strong></span>
            </p>
          </div>
...
export default {
  ...
  asyncData({params, error}) {
    return orderMethod.getOrdersInfo(params.oid).then(response => {
      return {
